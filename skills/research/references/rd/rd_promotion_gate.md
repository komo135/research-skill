...
- Charter is written down and on file (`charter.md` + `decisions.md charter entry`)
...
- [ ] Charter exists, written down, record matches `decisions.md charter entry`
  - Evidence: `decisions.md charter entry` dated note == dated note comparison of `charter.md`
- [ ] No undocumented load-bearing charter amendments (scope, kill criteria,
  H7, H8, consumer, or promotion language)
  - Evidence: charter record / git history reviewed against deviation entries;
...
- [ ] Reproducibility 3-tuple recorded: data version, git commit,
  ...
  - Evidence: a selected tracker or local run note output or equivalent
...
- [ ] Data version, git commit, environment pin reference, and seed recorded for every
  promotion-cited trial in local run notes or in the selected tracker record
  / exported run record
...
- [ ] If an external tracker is used, every promotion-cited `trial_id`
  ...
  params, data version, git commit, environment pin reference, and seed
...
Charter reference: <dated_note from decisions.md charter entry>
...
Project is written down. No ongoing maintenance. Future use of the
