...
`research-skill` is a Claude Code and Codex plugin for **agent-driven R&D**. It gives agents intent intake, scoping literature, material/EDA, proposition workspace management, a proposition-first hypothesis lifecycle, independent plan review, independent result analysis, proposition-level research papers, and a quantitative research extension for time-series and statistically fragile evaluations.
